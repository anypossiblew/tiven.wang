...
* https://kyfw.12306.cn/otn/leftTicket/queryZ?leftTicketDTO.train_date=2018-01-28&leftTicketDTO.from_station=SHH&leftTicketDTO.to_station=UUH&purpose_codes=ADULT

点击 **预订** 按钮

* checkUser 检查用户登录状态还是否有效（如果登录无效会弹出登录窗口，页面不跳转） https://kyfw.12306.cn/otn/login/checkUser
* submitOrderRequest 提交预订单 https://kyfw.12306.cn/otn/leftTicket/submitOrderRequest
